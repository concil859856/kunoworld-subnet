...
# h3-turbo's weight and slope (one-GPU serving, measured 2026-09-17: h3-image-check_2026-09-17.md) and h3's slope
# (measured_2026-09-16_h3-turbo.md), and ltx-2.5-4k's weights and slope
...
def test_worked_examples():
    ...
    assert h3.vcu_for(params(h3, "768p", 14, 24)) == pytest.approx(2571.8)  # 100 × (1 + 0.093 × 9) × 14
